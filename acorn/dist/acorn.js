(function (global, factory) {
  ...
  pp$3.parseMaybeAssign = function (noIn, refDestructuringErrors, afterLeftParse) {
    ...
    var left = this.parseMaybeSlice(noIn, refDestructuringErrors);
  ...
  pp$3.parseMaybeSlice = function (noIn, refDestructuringErrors) {
    var startPos = this.start, startLoc = this.startLoc;
    var startIndex, endIndex, step; // can't name them 'start', 'end' because those are Parser properties
    if (!this.eat(types.colon)) {
      startIndex = this.parseMaybeConditional(noIn, refDestructuringErrors);

      if (this.type !== types.colon) { return startIndex; }
    ...
    var hasSecondColon = this.eat(types.colon);

    if (!hasSecondColon && this.type !== types.bracketR) {
      endIndex = this.parseMaybeConditional(noIn, refDestructuringErrors);

      hasSecondColon = this.eat(types.colon);
    }
